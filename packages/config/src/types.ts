...
export interface ResolverConfig {
	 ...
	 * to provide a custom implementation for. The modules listed here won't be included
	 * in the packed application.
...
export interface Config {
	...
	/**
	 * Choose which client package manager should be used (npm or yarn), by default `npm` is used.
	 */
